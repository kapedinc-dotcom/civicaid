...
//#region node_modules/.nitro/vite/services/ssr/assets/db-CvgYQMWO.js
var db_CvgYQMWO_exports = /* @__PURE__ */ __exportAll({
	n: () => ensureDbReady,
	r: () => getPglite,
	t: () => db_exports
});
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_profiles.sql": _0002_profiles_default
		});
...
//#endregion
export { ensureDbReady as n, getPglite as r, db_CvgYQMWO_exports as t };
