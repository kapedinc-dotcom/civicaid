...
import { n as ensureDbReady, r as getPglite } from "./db-CvgYQMWO.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-DF7TQW-l.js
...
async function getTrustedOrigins(options, request) {
	...
	const envTrustedOrigins = env$2.BETTER_AUTH_TRUSTED_ORIGINS;
...
Most of the features of Better Auth will not work correctly.`);
	const secretsArray = options.secrets ?? parseSecretsEnv(env$2.BETTER_AUTH_SECRETS);
	const legacySecret = options.secret || env$2.BETTER_AUTH_SECRET || env$2.AUTH_SECRET || "";
	let secret;
	let secretConfig;
	if (secretsArray) {
...
//#endregion
export { hasGateSessionMarker as a, gateIdentityEnabled as i, auth as n, env as o, authConfigured as r, isWorkspacePreview as s, GROK_PROVIDERS as t };
