...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BPKvrIGN.mjs");
...
var manifest = {
	"035ef7af06dc1df33121d6287d5addc99687bf44eb28547c1004f798327b22c2": {
		functionName: "pullCatalogSheet_createServerFn_handler",
		importer: () => import("./fetch-sheet-CN0cpidf.mjs")
	},
	"16c1e6e358ffa83e64b89be01c90b8994011832edd8a5ed4d4f88432a16fda46": {
		functionName: "pullCatalogFromDrive_createServerFn_handler",
		importer: () => import("./fetch-sheet-CN0cpidf.mjs")
	},
	"2c4985e96c199268f7f639534cb5e8e31d6b19d43286bf77416413db60ffde26": {
		functionName: "fetchSessionUser_createServerFn_handler",
		importer: () => import("../__root-EjZuskKA.mjs")
	},
	"6390c9ff08b2a59f7c7b227d0becfb065f507c829252d253e7dbda3941b9fb12": {
		functionName: "saveProfile_createServerFn_handler",
		importer: () => import("./profile-BPOYLzg3.mjs")
	},
	"ac303419f3bd6f94ee837f95e91005a600278deed4876cb96a25aa0d69185951": {
		...
		importer: () => import("./readiness-NPF4-2kb.mjs")
	},
	"f8745d92712f742dccf87270d7acf704e3ce897cbdd3eb8ccbf04778e7561011": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CIyIR1zB.mjs").then((n) => n.n).then((n) => n.t),
